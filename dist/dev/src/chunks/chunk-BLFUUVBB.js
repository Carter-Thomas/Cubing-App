...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-VIEFLN2D.js
...
function isOrbitPatternDataIdentical(orbitDefinition, orbitPatternData1, orbitPatternData2, options = {}) {
  for (let idx = 0; idx < orbitDefinition.numPieces; idx++) {
    if (!options?.ignorePieceOrientations && (orbitPatternData1.orientation[idx] !== orbitPatternData2.orientation[idx] || orbitPatternData1.orientationMod?.[idx] !== orbitPatternData2.orientationMod?.[idx])) {
      return false;
    }
...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-CULFM3I2.js
...
async function asyncGetPuzzleGeometry(puzzleName) {
  const puzzleGeometry = await import("./puzzle-geometry-YRI6C6UC.js");
...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-ZQFNVOD5.js
var wcaEvents = {
...
var cube2x2x2 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).cube2x2x2JSON
    )
  ),
  svg: async () => (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).cube2x2x2SVG,
  llSVG: getCached(
    async () => (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).cube2x2x2LLSVG
  ),
  pg: getCached(async () => {
...
var cube3x3x3 = {
  ...
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-NSCZM77Q-V3PYMVQP.js")).cube3x3x3SVG;
  }),
  llSVG: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-NSCZM77Q-V3PYMVQP.js")).cube3x3x3LLSVG;
  }),
  pg: getCached(async () => {
...
var clock = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).clockJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).clockSVG;
  })
};
...
var FTOPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "svg", getCached(async () => {
      return (await import("./puzzles-dynamic-unofficial-2RL6RPOO-Z2N5FTNE.js")).ftoSVG;
    }));
  }
  stickeringMask(stickering) {
...
var PyraminxPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "svg", getCached(async () => {
      return (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).pyraminxSVG;
    }));
  }
};
...
var square1 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).sq1HyperOrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).sq1HyperOrbitSVG;
  })
};
...
var kilominx = {
  ...
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-unofficial-2RL6RPOO-Z2N5FTNE.js")).kilominxSVG;
  })
};
var rediCube = {
  id: "redi_cube",
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-unofficial-2RL6RPOO-Z2N5FTNE.js")).rediCubeJSON
    )
  ),
  svg: async () => {
    return (await import("./puzzles-dynamic-unofficial-2RL6RPOO-Z2N5FTNE.js")).rediCubeSVG;
  }
};
...
var melindas2x2x2x2 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).melindas2x2x2x2OrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-EEMN2PI4-ZOWSPYYT.js")).melindas2x2x2x2OrbitSVG;
  })
};
var puzzles = {
...
//# sourceMappingURL=chunk-BLFUUVBB.js.map

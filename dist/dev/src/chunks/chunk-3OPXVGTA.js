...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-4MCJ7H5A.js
...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-J6EV75FJ.js
...
var searchDynamicSideEvents = from(() => import("./search-dynamic-sgs-side-events-PFWJK7HL-TT2QYOXV.js"));
var twsearchPromise = from(async () => import("./twsearch-ZUYNNUKY-7OFE444R.js"));
var twsearchCppPromise = from(async () => import("./twsearch-cpp-CUTU3IFM-CQXRGBQD.js"));
...
var dynamic4x4x4Solver = from(() => import("./search-dynamic-solve-4x4x4-JZPYKEUP-NGQR66QM.js"));
var randomSuffixes2 = [
  [null, "x", "x2", "x'", "z", "z'"],
  [null, "y", "y2", "y'"]
];
...
var dynamic = from(() => import("./search-dynamic-sgs-unofficial-YLGCKTJJ-KMKC5N6Q.js"));
async function randomFTOScramble() {
  mustBeInsideWorker();
  return new Alg(await (await dynamicFTOSolver).randomFTOScrambleString());
}
var dynamicKilominxSolver = from(() => import("./search-dynamic-solve-kilominx-WREDL6AE-JMB3M64L.js"));
...
var searchDynamicUnofficial = from(() => import("./search-dynamic-sgs-unofficial-YLGCKTJJ-KMKC5N6Q.js"));
...
//# sourceMappingURL=chunk-3OPXVGTA.js.map

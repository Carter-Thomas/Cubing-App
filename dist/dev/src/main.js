...
} from "./chunks/chunk-DPZOFIRD.js";
import {
  countAnimatedLeaves,
  countMetricMoves,
  countMoves
} from "./chunks/chunk-3OPXVGTA.js";
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./chunks/puzzle-geometry-YRI6C6UC.js")).getPuzzleDescriptionString(config.puzzle);

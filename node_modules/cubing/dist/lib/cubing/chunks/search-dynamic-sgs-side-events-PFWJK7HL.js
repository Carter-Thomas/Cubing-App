import {
  parseSGS
} from "./chunk-KDMCYBSC.js";
import {
  cube2x2x2,
  puzzles
} from "./chunk-ZQFNVOD5.js";
import "./chunk-CULFM3I2.js";
import {
  KPuzzle
} from "./chunk-VIEFLN2D.js";
...
// src/cubing/search/inside/solve/puzzles/dynamic/sgs-side-events/megaminx.sgs.ts
async function megaminxKPuzzleWithoutMO() {
  const { getPuzzleGeometryByName, ExperimentalPGNotation } = await import("../puzzle-geometry/index.js");
...
async function cachedSGSDataMegaminx() {
  return cachedData2 ??= sgsDataMegaminx();
}
...
// src/cubing/search/inside/solve/puzzles/dynamic/sgs-side-events/pyraminx.sgs.ts
var cachedData3 = null;
async function sgsDataPyraminx() {
  return cachedData3 ??= uncachedSGSDataPyraminx();
}
...
// src/cubing/search/inside/solve/puzzles/dynamic/sgs-side-events/skewb.sgs.ts
...
async function skewbKPuzzleWithoutMOCached() {
  return defCache2 ??= skewbKPuzzleWithoutMO();
}
var cachedData4 = null;
async function sgsDataSkewb() {
  return cachedData4 ??= uncachedSGSDataSkewb();
}
...
//# sourceMappingURL=search-dynamic-sgs-side-events-PFWJK7HL.js.map
